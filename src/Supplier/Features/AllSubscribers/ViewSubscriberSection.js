...
import { SupplierRoutes, baseUrl, fontSize } from "../../../DefaultValues";
...
const ViewSubscriberSection = () => {
  ...
  const getData = (id) => {
    ...
    var config = {
      method: "get",
      url: `${SupplierRoutes.getSubscriber}/${id}`,
      headers: {
...
`;
export default ViewSubscriberSection;
